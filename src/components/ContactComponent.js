...
import { Control, LocalForm, ValidationErrors} from 'react-redux-form'
                    ...
                    <div className="col-12 col-md-9">
                        <LocalForm onSubmit={(values) => {this.handleSubmit(values)}}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".message" className="form-control" id="message" name="message" placeholder="First Name" rows="12"/>
                                </Col>
                            </Row>
                            <Row className="form-group">
